<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsProducts.aspx.cs" Inherits="admin_BsPg_BsProducts" %>
    ...
    <div id="divHead" class="divHead" runat="server">
        <div style="float: left; width: auto; padding-right: 5px">
                ...
                <label id="lblTitle" style="color: #15428B; padding-right: 0px; padding-left: 10px">
                    查询条件：</label></span> <span>
                        <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                            ...
                            <asp:ListItem Text="编号" Value="a.code^String"></asp:ListItem>
                            <asp:ListItem Text="名称" Value="a.name^String"></asp:ListItem>
                        </asp:DropDownList>
                        ...
                        <asp:DropDownList CssClass="dropList" Search_Compare="like_code" Search_Field="a.Bs_ProKindCode"
                            runat="server" ID="Search_Keyword1">
                        </asp:DropDownList>
                        <asp:DropDownList CssClass="dropList" Search_Compare="like_code" Search_Field="a.isindex"
                            runat="server" ID="Search_Keyword2">
                            <asp:ListItem Value="" Text="首页显示-全部"></asp:ListItem>
          ...
          <div style="float:left; width:auto; border:0px red solid;">
                 ...
                 <asp:LinkButton ID="btnIndexShow" SetField="isIndex" SetValue="1" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为首页显示</i></asp:LinkButton>
                 <asp:LinkButton ID="btnIndexHide" SetField="isIndex" SetValue="0" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>取消首页显示</i></asp:LinkButton>
    ...
    <div id="divContent" class="body" runat="server">
        ...
        <div id="divList" runat="server">
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%" CellPadding="3"
                ...
                <Columns>
                    <asp:TemplateField>
                        <HeaderStyle HorizontalAlign="Left" BorderWidth="1px" BorderStyle="Solid" Width="20px">
                        </HeaderStyle>
                    ...
                    <asp:BoundField HeaderText="序号" ReadOnly="True">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="36px">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="查看">
                        <ItemTemplate>
                            <a href='<%# getLinkWidthBaseParas("BsProItemMore.aspx","pkid",Eval("pkid").ToString()) %>'
                                target="_blank">查看</a>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="50px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="50px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="隐藏">
                        <ItemTemplate>
                            <%# Eval("status").ToString() == "0" ? "否" : "<font color=red>是</font>"%>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="40px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="40px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:TemplateField>
                     <asp:TemplateField HeaderText="首页显示">
                        <ItemTemplate>
                            <%# Eval("isindex").ToString() == "0" ? "否" : "<font color=red>是</font>"%>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Center" Width="60px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="60px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="图片" SortExpression="pic">
                        <ItemTemplate>
                            <img src='/upload/product/small/<%#Eval("pic") %>'
