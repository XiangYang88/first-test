<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsProComments.aspx.cs" Inherits="admin_BsPg_BsProComments" %>
<!--数据操作的页面模板-->
    ...
    <form id="frmList" runat="server">
          ...
          <div id="divHead" class="divHead" runat=server>
            <div style="float:left; width:auto; padding-right:5px">
                ...
                <span>                
                    ...
                    <asp:DropDownList CssClass="dropList" Search_Field="a.status"
                    runat="server" ID="Search_Keyword3">
                        <asp:ListItem Text="显示/隐藏" Value=""></asp:ListItem>
                        <asp:ListItem Text="显示" Value="0"></asp:ListItem>
                   ...
                   <asp:DropDownList CssClass="dropList" Search_Field="a.isnew"
                    ...
                    <asp:DropDownList CssClass="dropList" Search_Field="a.isreply"
                    runat="server" ID="Search_Keyword2">
                        <asp:ListItem Text="未/已回复" Value=""></asp:ListItem>
                        <asp:ListItem Text="未回复" Value="1"></asp:ListItem>
                        <asp:ListItem Text="已回复" Value="0"></asp:ListItem>
                    </asp:DropDownList>
             ...
             <div style="float:left; width:auto; border:0;">
            ...
            <div style="clear:both;padding-left:10px" runat=server id="divProCommentsBatch">
                 <asp:LinkButton ID="btnShow" SetField="status" SetValue="0" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为显示</i></asp:LinkButton>
                 <asp:LinkButton ID="btnNoHide" SetField="status" SetValue="1" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>设为隐藏</i></asp:LinkButton>
                  <asp:LinkButton ID="btnRead" SetField="isnew" SetValue="0" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为已读</i></asp:LinkButton>
                 <asp:LinkButton ID="btnNoRead" SetField="isnew" SetValue="1" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>设为未读</i></asp:LinkButton>
                   <asp:LinkButton ID="btnReply" SetField="isreply" SetValue="1" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listshow"></span><i>设为已回复</i></asp:LinkButton>
                 <asp:LinkButton ID="btnNoReply" SetField=">" SetValue="0" OnClick="btnSetItemValue_Click" CssClass="dot_Item" runat="server"><span class="Icon_item icon_listhide"></span><i>设为未回复</i></asp:LinkButton>
            ...
            <div id="divList" runat="server">
             ...
             <asp:CommandField HeaderText="查看" SelectText="查看" ShowSelectButton="True">
                ...
                <ItemTemplate>
                    ...
                    <HeaderStyle HorizontalAlign="Center" Width="35px" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" Width="35px" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:TemplateField>  
                ...
                <asp:TemplateField HeaderText="未/已回复" SortExpression="isReply">
                    <ItemTemplate>
                       <%# Eval("isReply").ToString() == "1" ? "已回复" : "<font color=red>未回复</font>"%>
                    </ItemTemplate>
               ...
               <asp:TemplateField HeaderText="会员" SortExpression="UserName">
                    <ItemTemplate>
                       <%# Eval("UserName").ToString() == "" ? "游客" : Eval("UserName").ToString()%>
                    </ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center"  BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:TemplateField>
                <asp:BoundField DataField="ProName" DataFormatString="{0}" HeaderText="产品名" SortExpression="Name">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="Name" DataFormatString="{0}" HeaderText="姓名" SortExpression="Name">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="AddTime" DataFormatString="{0}" HeaderText="评论时间" SortExpression="AddTime">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></ItemStyle>
                </asp:BoundField>
             <asp:BoundField DataField="ReTime" DataFormatString="{0}" HeaderText="回复时间" SortExpression="ReTime">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></ItemStyle>
                </asp:BoundField>
                </Columns>
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
            ...
            <tr><td class="tdLeft">标题：</td>
                <td colspan=3><input title="标题" class="textBg" type="text" runat="server" id="KK_title" Lock=1 style="width:501px"/></td>
                
            </tr>
            <tr><td class="tdLeft">内容：</td>
                <td colspan=3><textarea title="内容" runat="server" id="KK_content" Lock=1 style="width:500px; height: 143px;"></textarea>
                </td>
