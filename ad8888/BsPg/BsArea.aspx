<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsArea.aspx.cs" Inherits="admin_BsPg_BsArea" %>
            ...
            <tr style="<%=display%>">
             <td class="tdLeft">
                ...
                <td >
                    ...
                    <iframe scrolling="no" width="400" height="200" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic&multi=false&filelist=<%=this.KK_Pic.Value %>&pathlist=upload|550|300">
                    </iframe>
                    </td>
            <td class="tdLeft">商场地址：</td>
                <td  >
                <textarea class="textCSS" title="介绍" runat="server" style="width:300px; height:190px" id="KK_Notes">
                </textarea>
                </td>
            </tr>
