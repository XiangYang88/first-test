<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsProProperty.aspx.cs" Inherits="admin_BsPg_BsProProperty" %>
<!--数据操作的页面模板-->
    ...
    <form id="frmList" runat="server">
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
            ...
            <tr><td class="tdLeft">编　　号：</td>
                <td><input class="textBg" title="编号" type="text" runat="server"  lock="1" id="KK_Code" style="width:150px"/></td>
            ...
            <tr>
                ...
                <iframe scrolling="no" width="800" height="190" frameborder=0
                 src="../uploadIframe.aspx?id=KK_Pic&multi=false&filelist=<%=this.KK_Pic.Value %>"></iframe>
                  <br />
                    <font color="red">图片尺寸：158px*158px</font>
                </td>
            </tr>  
            <tr><td class="tdLeft">操　　作：</td>
                <td colspan="3">
