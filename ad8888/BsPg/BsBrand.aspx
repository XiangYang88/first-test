<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsBrand.aspx.cs" Inherits="admin_BsPg_BsBrand" %>
 <!--数据操作的页面模板-->
        ...
        <!--Content-->
            ...
            <div id="divList" runat="server">
                ...
                <asp:TemplateField HeaderText="产品数">
                    ...
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    <ItemTemplate>
                      <a href='<%# getLinkWidthBaseParas("BsProducts.aspx","C_Bs_BrandCode",Eval("code").ToString())%>'>
                            <%# Eval("proCount") %>
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
                
                <asp:TemplateField HeaderText="下级品牌数">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px"  BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                    <ItemTemplate><%# Eval("brandCount") %>
                    </ItemTemplate>
                </asp:TemplateField>
