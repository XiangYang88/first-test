<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsNewsList2.aspx.cs" Inherits="admin_BsPg_BsNewsList2" %>
                            ...
                            <tr style="<%=hasimg %>">
                                ...
                                <td>
                                    ...
                                    <%}
                                      ...
                                      { %>
                                    <font color="gray">没有缩略图请留空！尺寸不建议大于773px*204px</font>
                                    <%} %>
                                </td>
                            </tr>
                            <tr style="<%=hasurl%>">
                                ...
                                <td>
                                    ...
                                    <br />
                                    <font color="red">图片最佳尺寸：1000px*900px</font><br />
                        ...
                        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                            ...
                            <tr style="<%=hasimg %>">
                                ...
                                <td>
                                    ...
                                    <iframe scrolling="auto" width="600" height="250" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic_en&filelist=<%=this.KK_Pic_en.Value %>&multi=true&pathlist=upload|0|0,upload/article/small|270|270"></iframe>
                                    <br />
                                    <%if (imagesize != "")
                                      {%><font color="red">图片最佳尺寸：<%=imagesize%></font><br />
                                    <%}
                            ...
                            <tr style="<%=hasurl%>">
                                ...
                                <td>
                                    <input type="text" title="小图" id="KK_Pic_small_en" runat="server" style="display: none" />
                                    <iframe scrolling="auto" width="600" height="250" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic_small_en&multi=true&filelist=<%=this.KK_Pic_small_en.Value %>"></iframe>
                                    <br />
                                    <font color="gray"></font>
                                </td>
                            </tr>
