<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsUserGrade.aspx.cs" Inherits="admin_BsPg_BsUserGrade" %>
<!--数据操作的页面模板-->
    ...
    <form id="frmList" runat="server">
        ...
        <!--Content-->
            ...
            <div id="divList" runat="server">
                ...
                <asp:BoundField DataField="Discount" DataFormatString="{0}" HeaderText="会员折扣" SortExpression="Discount">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
            ...
            <tr>
                ...
                <td class="tdLeft">折　　扣：</td>
                <td><input class="textBg" title="折扣" type="text" runat="server" id="KK_Discount" style="width:150px"/></td>
            </tr>            
