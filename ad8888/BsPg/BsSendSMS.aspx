<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsSendSMS.aspx.cs" Inherits="admin_BsPg_BsSendSMS" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showUser()
        {
            if(data==null)
            {
               $.post("../Rx/UserMobileList.ashx",{},function(d){
                    data=eval(d);
        ...
        function showTemplate(pkid)
        {
            if(pkid!="")
            {
                $.post("../Rx/ShowTemplateContent.ashx",{pkid:pkid,type:'SMS'},function(data){
                    $("#KK_Content").val($("#KK_Content").val() + data);
                });
            }
        }
    </script>
    ...
    <form id="frmList" runat="server">
        ...
        <!--Content-->
            ...
            <div id="divList" runat="server">
             ...
             <asp:CommandField HeaderText="查看" SelectText="查看" ShowSelectButton="True">
                ...
                <asp:BoundField DataField="Content" DataFormatString="{0}" HeaderText="内容" SortExpression="Content">
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
            ...
            <colgroup>
             ...
             <tr>
                <td class="tdLeft">接收手机：</td>
                <td >
                <input type="text" value="" style="width:218px"  class="textBg" id="KK_Receiver" runat=server/>
                <input type=button value="选择会员手机号码" onclick="showUser()" />
                </td>
            </tr>  
            ...
            <tr><td class="tdLeft">发送内容：</td>
                <td colspan="3">
                <textarea class="textCSS" title="发送内容"
                 runat="server" style="width:300px; height:90px" id="KK_Content"></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td >
                <textarea class="textCSS" title="备注" runat="server" style="width:300px; height:50px" id="KK_Notes"></textarea>
                </td>               
            </tr>  
