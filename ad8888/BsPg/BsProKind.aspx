<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsProKind.aspx.cs" Inherits="admin_BsPg_BsProKind" %>
   ...
   <link href="../style/Style.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        $(function () {
            ...
            editor.render("KK_Notes");
            var editor_en = new UE.ui.Editor();
            editor_en.render("KK_Notes_en");
        })
    </script>
</head>
<body>
            ...
            <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%" CellPadding="3"
                ...
                <Columns>
                    ...
                    <asp:CommandField HeaderText="查看" SelectText="查看" ShowSelectButton="True">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="35px">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="35px">
                        </ItemStyle>
                    </asp:CommandField>
                    ...
                    <asp:TemplateField HeaderText="产品数">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                        <ItemTemplate>
                            <a href='<%# getLinkWidthBaseParas("BsProducts.aspx","L_Bs_ProKindCode",Eval("code").ToString())%>'>
                                <%# Eval("proCount") %>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="下级分类数" >
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                        <ItemTemplate>
                            <%# Eval("kindCount") %>
                    ...
                    <asp:BoundField DataField="SortNo" DataFormatString="{0}" HeaderText="排序号" SortExpression="SortNo">
                        <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="50px">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="50px">
                        </ItemStyle>
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="显示/隐藏">
                        ...
                        <HeaderStyle HorizontalAlign="Center" Width="80px" BorderWidth="1px" BorderStyle="Solid">
                        </HeaderStyle>
                        <ItemStyle HorizontalAlign="Center" Width="80px" BorderWidth="1px" BorderStyle="Solid">
                        </ItemStyle>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
    ...
    <div id="divDtls" class="divFoot body" runat="server" visible="false">
        ...
        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
            ...
            <tr>
                ...
                <td>
                    <input class="textBg" title="编号" type="text" runat="server" lock="1" id="KK_Code" style="width: 150px" />
                </td>
                <td class="tdLeft">
                    排 序 号：
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input class="textBg" title="名称" type="text" runat="server" id="KK_Name" style="width: 150px" />
             ...
             <tr>
                ...
                <td colspan="3">
                    ...
                    <iframe scrolling="no" width="400" height="190" frameborder="0" src="../uploadIframe.aspx?id=KK_Pic&multi=false&filelist=<%=this.KK_Pic.Value %>">
                    </iframe>
                    <br />
                    <font color="red">最佳尺寸:198px*103px</font>
                </td>
            </tr>
          <%-- <tr>
                <td class="tdLeft">
                ...
                <td colspan="3">
                    <textarea title="备注" runat="server" id="KK_Notes"></textarea>
                </td>
            </tr>--%>
               <%if(Common.Utils.OpenSeo()){ %><tr>
                <td class="tdLeft">
                    Seo：
                </td>
                <td colspan="3">
            ...
            <tr>
                ...
                <td colspan="3">
                    <input class="textBg" title="名称" type="text" runat="server" id="KK_Name_en" style="width: 150px" />
         ...
         <%--  <tr>
                ...
                <td colspan="3">
                    <textarea title="备注" runat="server" id="KK_Notes_en"></textarea>
                </td>
            </tr>--%>
               <%if(Common.Utils.OpenSeo()){ %><tr>
                <td class="tdLeft">
