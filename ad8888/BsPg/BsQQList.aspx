<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsQQList.aspx.cs" Inherits="admin_BsPg_BsQQList" %>
                        ...
                        <label id="lblTitle" style="color: #15428B; padding-right: 0px; padding-left: 10px">
                            查询条件：</label></span> <span>
                                <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                                    ...
                                    <asp:ListItem Text="名称" Value="title^String"></asp:ListItem>
                                    <asp:ListItem Text="QQ号" Value="notes^String"></asp:ListItem>
                ...
                <div id="divList" runat="server">
                    <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Title" DataFormatString="{0}" HeaderText="名称" SortExpression="Title">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>

                            <asp:BoundField DataField="notes" DataFormatString="{0}" HeaderText="QQ号" SortExpression="notes">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>
                    ...
                    <div class="body">
                        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input title="名称" class="textBg" type="text" runat="server" id="KK_Title" style="width: 200px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLeft">QQ号码：
                                </td>
                                <td>
                                    <input title="QQ号码" class="textBg" type="text" runat="server" id="KK_Notes" style="width: 200px" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdLeft">排序号：
                    ...
                    <div class="body">
                        <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input title="名称" class="textBg" type="text" runat="server" id="KK_Title_en" style="width: 200px" />
                                </td>
                            </tr>                          
                        </table>
                    </div>
