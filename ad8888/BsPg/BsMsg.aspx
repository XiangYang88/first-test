<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsMsg.aspx.cs" Inherits="bspg_BsMsg" %>
                ...
                <div style="float: left; width: auto; padding-right: 5px">
                    ...
                    <span>
                        <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                            ...
                            <asp:ListItem Text="联系人" Value="name^String"></asp:ListItem>
                            <asp:ListItem Text="标题" Value="title^String"></asp:ListItem>
                            <asp:ListItem Text="内容" Value="content^String"></asp:ListItem>
                        </asp:DropDownList>
                ...
                <div id="divList" runat="server">
                    <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%"
                        ...
                        <Columns>
                            ...
                            <%-- <asp:TemplateField HeaderText="会员" SortExpression="UserName" Visible="false">
                    <ItemTemplate>
                    ...
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            ...
                            <%--<asp:BoundField DataField="name" DataFormatString="{0}" HeaderText="联系人" SortExpression="name">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>--%>
                            ...
                            <asp:BoundField DataField="phone" DataFormatString="{0}" HeaderText="电话" SortExpression="phone">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="email" DataFormatString="{0}" HeaderText="邮箱" SortExpression="email">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>
                            <asp:BoundField DataField="AddTime" DataFormatString="{0}" HeaderText="留言时间" SortExpression="AddTime">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>
            ...
            <div id="divDtls" class="divFoot" runat="server" visible="false">
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="姓名" class="textBg" type="text" runat="server" id="KK_name" lock="1" style="width: 200px" /></td>
                        <td class="tdLeft">邮箱：</td>
                        <td>
                            <input title="邮箱" class="textBg" type="text" runat="server" id="KK_email" lock="1" style="width: 200px" /></td>
                    </tr>
                    <tr>
                        <td class="tdLeft">联系电话：</td>
                        <td>
                            <input title="联系电话" class="textBg" type="text" runat="server" id="KK_phone" lock="1" style="width: 200px" /></td>
