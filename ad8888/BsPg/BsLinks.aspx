<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsLinks.aspx.cs" Inherits="admin_BsPg_BsLinks" %>
        ...
        <form id="frmList" runat="server">
                ...
                <div style="float: left; width: auto; padding-right: 5px">
                    ...
                    <span>
                        ...
                        <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                            ...
                            <asp:ListItem Text="链接" Value="url^String"></asp:ListItem>
                        </asp:DropDownList>
                ...
                <div id="divList" runat="server">
                    <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Name" DataFormatString="{0}" HeaderText="链接名" SortExpression="Title">
                            ...
                            <asp:TemplateField HeaderText="链接类型">
                                <ItemTemplate><%# getTypeName() %></ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:TemplateField>

                            <%-- <asp:TemplateField HeaderText="图片">
                    <ItemTemplate><%# getPic(Eval("Logo")) %></ItemTemplate>
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" ></ItemStyle>
                </asp:TemplateField>--%>
            ...
            <div id="divDtls" class="divFoot" runat="server" visible="false">
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    ...
                    <tr>
                        <td class="tdLeft">链接名：</td>
                        <td colspan="3">
                            <input title="链接名" class="textBg" type="text" runat="server" id="KK_Name" style="width: 350px" /></td>
                    </tr>
                    <tr>
                        <td class="tdLeft">链接英文名：</td>
                        <td colspan="3">
                            <input title="链接名" class="textBg" type="text" runat="server" id="KK_Name_en" style="width: 350px" /></td>
                    </tr>
                    <tr>
                        <td class="tdLeft">链接地址：</td>
                        <td colspan="3">
                            <input title="链接地址" class="textBg" type="text" runat="server" id="KK_Url" style="width: 350px" /></td>
                    </tr>
                    <tr>
                        <td class="tdLeft">排序号：</td>
                        <td colspan="3">
                            <input class="textBg" title="排序号" type="text" runat="server" id="KK_SortNo" style="width: 50px" />
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" title="Logo" id="KK_Logo" runat="server" style="display: none" />
                            <iframe scrolling="no" width="800" height="190" frameborder="0"
                                src="../uploadIframe.aspx?id=KK_Logo&multi=false&filelist=<%=this.KK_Logo.Value %>"></iframe>
                            <br />

                            <font color="red">尺寸：105px*49px</font>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <textarea class="textCSS" title="备注" runat="server" style="width: 511px; height: 71px" id="KK_Notes"></textarea>
