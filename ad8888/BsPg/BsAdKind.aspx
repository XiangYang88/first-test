<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BsAdKind.aspx.cs" Inherits="admin_BsPg_BsAdKind" %>
<!--数据操作的页面模板-->
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
           ...
           <colgroup>
            ...
            <tr><td class="tdLeft">编　　号：</td>
                <td><input class="textBg" title="编号" type="text" lock="1" runat="server" id="KK_Code" style="width:150px"/></td>
            ...
            <tr>
                ...
                <td colspan="3"><input class="textBg" title="名称" type="text" runat="server" id="KK_Name" style="width:150px"/></td>
            
                <td class="tdLeft" style="display:none">属　　性：</td>
                <td style="display:none"><asp:CheckBox ID="KK_status" title="是否隐藏" runat="server" Checked="true" Text="是否隐藏"/>
                    </td>                
            </tr>            
           ...
           <tr style="display:none">
                ...
                <td colspan=3>
                <textarea class="textCSS" title="备注" runat="server" style="width:540px; height:111px" id="KK_Notes"></textarea>
                </td> 
            </tr>   
