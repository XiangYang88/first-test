<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SyMenu.aspx.cs" Inherits="sys_SyMenu" %>
    ...
    <form id="frmList" runat="server">
            ...
            <div style="float:left; width:auto; padding-right:5px">
                ...
                <span>
                    ...
                    <input Search_FieldID="Search_Field0" Search_CompareID="Search_Compare0"
                     ...
                     每页显示<input type="text" value="20" runat="server" class="textSearch" id="txtPageSize" style="width:30px" />条 
        ...
        <div id="divDtls" class="divDtls"  runat="server" visible="false">
          ...
          <colgroup>
            ...
            <tr><th>名　　称：</th>
                <td><input class="textBg" title="名　　称" type="text" runat="server" id="KK_name" style="width:150px"/>
                </td>
                <th>编　　号：</th>
                <td><input class="textBg" title="编　　号" type=text runat=server id="KK_Code" 
                 value="10" style="width:150px"/>
                 <input class="textBg" type=text runat=server id="txtCode" 
                 value="10" style="display:none"/>
                 </td>
            </tr>
            <tr><th>调用页面：</th>
                <td><input class="textBg" title="调用页面" type="text" runat="server" id="KK_func" style="width:350px"/></td>
                <th>属　　性：</th>
                <td><asp:CheckBox ID="KK_EnMode" title="是否末级" runat="server" Text="是否末级"/></td>
            </tr>
            
            <tr><th>菜单图标：</th>
                <td><input class="textBg" type="text" title="菜单图标" runat="server" id="KK_Icon" style="width:150px"/></td>
                <th>排　　序：</th>
                <td><input class="textBg" type=text title="排　　序" runat=server id="KK_SortNo" value="10" style="width:150px"/></td>
            </tr>
            ...
            <div id="divList" runat="server">
                ...
                <asp:BoundField DataField="Name" SortExpression="Name" DataFormatString="{0}" HeaderText="名称">
                 ...
                 <asp:TemplateField HeaderText="">
                    ...
                    <ItemTemplate>
                        <%# 
                            getViewUrl(Eval("EnMode"),Eval("code"))
                            %>
                       
                    </ItemTemplate>
                </asp:TemplateField>
              
                <asp:BoundField DataField="func" SortExpression="func" DataFormatString="{0}" HeaderText="调用页面">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                
                <asp:BoundField DataField="SortNo" SortExpression="SortNo" DataFormatString="{0}" HeaderText="排序">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
