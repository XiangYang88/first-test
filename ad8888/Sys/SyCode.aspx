<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SyCode.aspx.cs" Inherits="sys_SyCode" %>
                ...
                <div id="divList" runat="server">
                    <asp:GridView ID="gvList" runat="server" CssClass="defaultGridV" Width="100%"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SortNo" DataFormatString="{0}" HeaderText="排序号">
                                <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                                <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                            </asp:BoundField>
                ...
                <table class="defaultTbl" cellpadding="1px" cellspacing="1px">
                    <colgroup>
                     ...
                     <tr>
                        ...
                        <td>
                            <input class="textBg" type="text" title="编号" lock="1" runat="server" id="KK_Code" style="width: 150px" /></td>
                    </tr>
                    <tr>
                        <td class="tdLeft">名　　称：</td>
                        <td>
                            <input class="textBg" type="text" title="名称" runat="server" id="KK_name" style="width: 150px" /></td>
                    </tr>
                   
                    <tr>
                        <td class="tdLeft">排　　序：</td>
                        <td>
                            <input class="textBg" type="text" title="排序" runat="server" id="KK_SortNo" style="width: 150px" /></td>

                    </tr>

                    <tr>
                        <td class="tdLeft">备注说明：</td>
                        <td>
                            <textarea class="textCSS" title="备注说明" runat="server" id="KK_notes" style="width: 400px; height: 50px">
                </textarea></td>
                    </tr>
