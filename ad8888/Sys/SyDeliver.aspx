<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SyDeliver.aspx.cs" Inherits="sys_SyDeliver" %>
    ...
    <form id="frmList" runat="server">
        ...
        <!--Content-->
            ...
            <div id="divList" runat="server">
                ...
                <asp:BoundField DataField="Url" DataFormatString="{0}" HeaderText="网址">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                
                <asp:BoundField DataField="Content" DataFormatString="{0}" HeaderText="说明">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
        ...
        <div id="divDtls" class="divFoot" runat="server" visible="false">
          ...
          <colgroup>
            ...
            <tr><td class="tdLeft">编　　号：</td>
                <td><input title="编号" class="textBg" type="text" lock="1" runat="server" id="KK_Code" style="width:150px"/></td>
            
            <td class="tdLeft">网　　址：</td>
                <td ><input title="网址" class="textBg" type="text" runat="server" id="KK_Url" style="width:150px"/></td>
            
                </tr>
            <tr>
            <td class="tdLeft">名　　称：</td>
                <td><input title="名称" class="textBg" type="text" runat="server" id="KK_name" style="width:150px"/></td>
                <td class="tdLeft">排　　序：</td>
                <td><input title="排序" class="textBg" type="text" runat="server" id="KK_SortNo" style="width:50px"/></td>
            </tr>
            <tr>
                <td class="tdLeft">运输费用：</td>
                <td><input title="名称" class="textBg" type="text" runat="server" id="KK_Amount" style="width:150px"/></td>
                <td class="tdLeft">属性：</td>
                    <td colspan=3><asp:CheckBox ID="KK_status" title="是否隐藏" runat="server" Text="是否隐藏"/>
                    </td>
               </tr>
            <tr><td class="tdLeft">备注说明：</td>
                <td colspan="3"><textarea class="textCSS" runat="server" id="KK_Content" style=" width:400px; height:50px"></textarea></td>
            </tr>
