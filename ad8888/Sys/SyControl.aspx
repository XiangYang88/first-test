<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SyControl.aspx.cs" Inherits="admin_sys_SyControl" %>
    ...
    <form id="frmList" runat="server">
            ...
            <div style="float:left; width:auto; padding-right:5px">
                ...
                <span>
                    ...
                    <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                        ...
                        <asp:ListItem Text="控件ID" Value="ControlID^String"></asp:ListItem>
        ...
        <div id="divDtls" class="divDtls"  runat="server" visible="false">
          ...
          <colgroup>
            ...
            <tr><td class="tdLeft">名　　称：</td>
                <td><input class="textBg" type="text" title="名　　称" runat="server" id="KK_name" style="width:150px"/>
                </td>
                <td class="tdLeft">控件ID：</td>
                <td><input class="textBg" title="控件ID" type=text runat=server id="KK_controlID" value="10" style="width:150px"/></td>
            </tr>
            <tr><td class="tdLeft">排　　序：</td>
                <td><input class="textBg" type="text"  title="排　　序"  runat="server" id="KK_SortNo" style="width:150px"/></td>
                <td class="tdLeft">属　　性：</td>
                <td><asp:CheckBox ID="KK_Status" runat="server" title="禁用状态" Text="是否禁用"/></td>
            </tr>
        ...
        <div id="divContent" class="body" runat=server>
            ...
            <div id="divList" runat="server">
                ...
                <asp:BoundField DataField="ID" SortExpression="ID" DataFormatString="{0}" HeaderText="ID">
                ...
                <asp:BoundField DataField="Name" SortExpression="Name" DataFormatString="{0}" HeaderText="名称">
                 ...
                 <asp:BoundField DataField="controlID" SortExpression="controlID" DataFormatString="{0}" HeaderText="控件ID">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
              ...
              <asp:TemplateField HeaderText="可用/不可用">
                <ItemTemplate>
                    <%# Eval("status").ToString()=="0"?"可用":"<font color=red>不可用</font>" %>
                </ItemTemplate>
