<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SyLog.aspx.cs" Inherits="admin_sys_SyLog" %>
<!--查询,统计的页面模板-->
...
<body  ><div class="column_Box mainAutoHeight">
    <form id="frmList" runat="server">
            ...
            <div style=" float:left; width:auto; padding-right:5px">
                ...
                <span>
                    ...
                    <asp:DropDownList CssClass="dropList" runat="server" ID="Search_Field0">
                        ...
                        <asp:ListItem Text="栏目" Value="menu^String"></asp:ListItem>
                    ...
                    时间:<input Search_Field="AddTime^String" Search_Compare=">"
                     class="textSearch" type="text" runat="server" id="Search_Keyword1" />-
                     <input Search_Field="AddTime^String" Search_Compare="<"
            ...
            <tr style="display:none"><td class="tdLeft">选择导出内容：</td>
                <td>
                    <asp:CheckBoxList runat=server RepeatColumns=8 ID="cblExportField">
                        ...
                        <asp:ListItem Value="menu" Selected=true>栏目</asp:ListItem>
                        <asp:ListItem Value="type" Selected=true>类型</asp:ListItem>
                        <asp:ListItem Value="ip" Selected=true>IP</asp:ListItem>
                        <asp:ListItem Value="addTime" Selected=true>时间</asp:ListItem>
                    </asp:CheckBoxList>
        ...
        <div id="divContent" class="body" runat=server>
            ...
            <div id="divList" runat="server">
                ...
                <asp:BoundField DataField="menu" SortExpression="menu" DataFormatString="{0}" HeaderText="栏目">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="type" SortExpression="menu" DataFormatString="{0}" HeaderText="类型">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="tblName" SortExpression="tblName" DataFormatString="{0}" HeaderText="数据表">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="pkid" SortExpression="pkid" DataFormatString="{0}" HeaderText="数据主键">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                ...
                <asp:BoundField DataField="AddTime" SortExpression="AddTime" DataFormatString="{0}" HeaderText="时间">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid"></ItemStyle>
                </asp:BoundField>
                  <asp:CommandField HeaderText="备注" SelectText="查看备注" ShowSelectButton="True">
                    <HeaderStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="70px"></HeaderStyle>
                    <ItemStyle HorizontalAlign="Center" BorderWidth="1px" BorderStyle="Solid" Width="70px"></ItemStyle>
                </asp:CommandField>
            </Columns>
            </asp:GridView> 
            <!--分页-->
