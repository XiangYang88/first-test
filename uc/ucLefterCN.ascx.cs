...
public partial class uc_ucLefterCN : System.Web.UI.UserControl
{
    ...
    public string kindname,kindname_en;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(pcode))
        {
            ...
            kindname = BLL.Article.Kind.getKindName(code.Substring(0,2));
            //kindname_en = BLL.Article.Kind.getKindName(code.Substring(0, 2),"_en");
        }
        else
        {
