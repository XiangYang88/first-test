...
namespace Common
{
    public class Utils
    {
        ...
        {
            return HNKeys.ASSEMBLY_VERSION;
        }
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        public static bool OpenSeo()
        {
            return CSA.Config.ConfigHelper.getApp("SeoOpen")=="1";
        }
        /// <summary>
        /// 是否开启多语言英文 、对应模板字段必须加上对应字段
        /// </summary>
        /// <returns></returns>
        private static bool MultiLanguage(string luangue)
        {
            return CSA.Config.ConfigHelper.getApp("Language").Contains(luangue);
        }
        /// <summary>
        /// 是否开启英文版
        /// </summary>
        /// <returns></returns>
        public static bool MultiLanguageEN()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool MultiLanguageRU()
        {
